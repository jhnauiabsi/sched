...
class DeleteMessageBatchCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteMessageBatchRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DeleteMessageBatchResult.filterSensitiveLog,
        };
